document.addEventListener("DOMContentLoaded", function () {
  const subAreas = [
    ...
    },
    {
      ...
      link: "autorizacionesPermisosTrabajo.html",
    },
    {
      name: "REUNIONES – ACTAS DE REUNIÓN",
      color: "item-pink",
      icon: "bi-calendar-event",
      link: "reunionesActas.html",
    },
    {
      name: "CONTROL DE ACCESO PARA VIGILANTES O SUPERVISORES",
      color: "item-cyan",
      icon: "bi-door-open",
      link: "controlAccesoVigilantes.html",
    },
    {
      name: "INTEGRACIÓN VÍA API CON TORNOS DE ACCESO",
      color: "item-indigo",
      icon: "bi-plug",
      link: "integracionAPIConTornosAcceso.html",
    },
  ];
