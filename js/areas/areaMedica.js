  ...
  const subAreas = [
    {
      ...
      link: "/html/areas/subareas/medica/programacionActividades.html",
    },
    {
      name: "CONVOCATORIAS PARA ACTOS MÉDICOS",
      color: "item-teal",
      icon: "bi-file-earmark-check",
      link: "/html/areas/subareas/medica/convocatoriasMedicas.html",
    },
    {
      name: "AGENDA DE CITACIONES – SISTEMA DE AUTOCITA",
      color: "item-cyan",
      icon: "bi-calendar-event",
      link: "/html/areas/subareas/medica/autocita.html",
    },
    {
      name: "CONFIGURACIÓN DE PROTOCOLOS MÉDICOS",
      color: "item-orange",
      icon: "bi-gear",
      link: "/html/areas/subareas/medica/configuracionProtocolos.html",
    },
    {
      name: "PLANIFICACIONES POR PUESTOS VS PROTOCOLOS MÉDICOS",
      color: "item-indigo",
      icon: "bi-clipboard-check",
      link: "/html/areas/subareas/medica/planificacionesPuestos.html",
    },
    {
      name: "PLANIFICACIONES DE RECONOCIMIENTOS INDIVIDUALIZADAS",
      color: "item-pink",
      icon: "bi-person-check",
      link: "/html/areas/subareas/medica/reconocimientosIndividualizados.html",
    },
    {
      name: "RECONOCIMIENTOS MÉDICOS LABORALES",
      color: "item-cyan",
      icon: "bi-heart-pulse",
      link: "/html/areas/subareas/medica/reconocimientosLaborales.html",
    },
    {
      name: "ANALÍTICAS – PETITORIOS E IMPORTACIÓN DE RESULTADOS",
      color: "item-pink",
      icon: "bi-file-earmark-text",
      link: "/html/areas/subareas/medica/analiticasResultados.html",
    },
    {
      name: "RECONOCIMIENTOS EXTERNOS - IMPORTACIÓN DE APTITUDES",
      color: "item-orange",
      icon: "bi-arrow-right-circle",
      link: "/html/areas/subareas/medica/reconocimientosExternos.html",
    },
    {
      name: "CONSULTAS MÉDICAS ASISTENCIALES",
      color: "item-red",
      icon: "bi-file-earmark-medical",
      link: "/html/areas/subareas/medica/consultasMedicas.html",
    },
    {
      name: "CAMPAÑAS DE VACUNACIÓN",
      color: "item-teal",
      icon: "bi-h-square",
      link: "/html/areas/subareas/medica/campanasVacunacion.html",
    },
    {
      name: "CONTROLES SEROLÓGICOS",
      color: "item-indigo",
      icon: "bi-clipboard-data",
      link: "/html/areas/subareas/medica/controlesSerologicos.html",
    },
    {
      name: "INVESTIGACIÓN DE ACCIDENTES CON RIESGO BIOLÓGICO",
      color: "item-red",
      icon: "bi-exclamation-triangle",
      link: "/html/areas/subareas/medica/accidentesRiesgoBiologico.html",
    },
    {
      name: "INCAPACIDADES TEMPORALES",
      color: "item-orange",
      icon: "bi-calendar-x",
      link: "/html/areas/subareas/medica/incapacidadesTemporales.html",
    },
    {
      name: "ESTUDIOS EPIDEMIOLÓGICOS",
      color: "item-teal",
      icon: "bi-bar-chart-line",
      link: "/html/areas/subareas/medica/estudiosEpidemiologicos.html",
    },
    {
      name: "PLANES DE PROMOCIÓN DE LA SALUD",
      color: "item-pink",
      icon: "bi-briefcase",
      link: "/html/areas/subareas/medica/planesPromocionSalud.html",
    },
    {
      name: "ESTUDIOS “AD HOC”",
      color: "item-indigo",
      icon: "bi-file-earmark-pdf",
      link: "/html/areas/subareas/medica/estudiosAdHoc.html",
    },
  ];
